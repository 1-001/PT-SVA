...
from openprompt.prompts import ManualTemplate,MixedTemplate,soft_template
...
prompt_model.load_state_dict(torch.load(os.path.join("E:\wjy\SOTitlePlus\SOTitlePlus\model_code\\vultypeprompt3 log", "best.ckpt"), map_location=torch.device('cuda:0')))
