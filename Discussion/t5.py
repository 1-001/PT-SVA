...
use_cuda = True
model_name = "t5"
pretrainedmodel_path = "E:\models\\t5-base"  # the path of the pre-trained model
...
train_dataloader = PromptDataLoader(dataset=read_prompt_examples(r"D:\wjy\data_c++\\train.xlsx"), template=mytemplate, tokenizer=tokenizer,
...
validation_dataloader = PromptDataLoader(dataset=read_prompt_examples(r"D:\wjy\data_c++\\valid.xlsx"), template=mytemplate, tokenizer=tokenizer,
                                         tokenizer_wrapper_class=WrapperClass, max_seq_length=max_seq_l,
                                         batch_size=batch_size, shuffle=True,
                                         teacher_forcing=False, predict_eos_token=False, truncate_method="head",
                                         decoder_max_length=3)
test_dataloader = PromptDataLoader(dataset=read_prompt_examples(r"D:\wjy\data_c++\\test.xlsx"), template=mytemplate, tokenizer=tokenizer,
                                   tokenizer_wrapper_class=WrapperClass, max_seq_length=max_seq_l,
                                   batch_size=batch_size, shuffle=True,
                                   teacher_forcing=False, predict_eos_token=False, truncate_method="head",
                                   decoder_max_length=3)
...
prompt_model.load_state_dict(torch.load(os.path.join("E:\last\\t5 log", "best.ckpt"), map_location=torch.device('cuda:0')))
